...
/** @package TBTKcalc
 *  @file GreensFunction2.h
 *  @brief Property container for the Green's function.
 *
 *  @author Kristofer Björnson
 */

#ifndef COM_DAFER45_TBTK_PROPERTY_GREENS_FUNCTION_2
#define COM_DAFER45_TBTK_PROPERTY_GREENS_FUNCTION_2
...
/** @brief Property container for the Green's function. */
class GreensFunction2 : public EnergyResolvedProperty<std::complex<double>>{
public:
	/** Enum class for specifying the Green's function type. */
	enum class Type{Advanced, Retarded, Principla, NonPrincipal, Matsubara};
...
inline GreensFunction2::Type GreensFunction2::getType() const{
	return type;
}
