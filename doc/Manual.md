...
In TBTK, each such index is referred to as a @link TBTK::Subindex Subindex@endlink and are grouped into an @link TBTK::Index Index@endlink such as {x, y, z, spin}.
...
Moreover, if one of the sublattices only has one orbital, it is possible to drop the orbital @link TBTK::Subindex Subindex@endlink completely for that sublattice.
...
A @link TBTK::Property::AbstractProperty Property@endlink may have been calculated using a specifier in one of the @link TBTK::Subindex Subindices@endlink.
