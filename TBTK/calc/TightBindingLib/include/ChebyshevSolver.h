...
public:
	...
	enum class GreensFunctionType{Advanced, Retarded, Principal, NonPrincipal};
	 ...
	 *  scaleFactor setBy setScaleFactor (default value 1).
	 */
	void generateGreensFunction(std::complex<double> *greensFunction, std::complex<double> *coefficients, int numCoefficients, int energyResolution, double lowerBound = -1., double upperBound = 1., GreensFunctionType type = GreensFunctionType::Advanced);
	 ...
	 */
	void generateGreensFunction(std::complex<double> *greensFunction, std::complex<double> *coefficients, GreensFunctionType type = GreensFunctionType::Advanced);
	 ...
	 * in the call to ChebyshevSolver::generateLookupTable
	 */
	void generateGreensFunctionGPU(std::complex<double> *greensFunction, std::complex<double> *coefficients, GreensFunctionType type = GreensFunctionType::Advanced);
