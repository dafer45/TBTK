...
dataset_abs = file['Dabs']
dataset_arg = file['Darg']

dimensions = dataset_abs.shape
...
fig.savefig('figures/Dabs.png')

Z = dataset_arg[:,:]
fig = matplotlib.pyplot.figure()
ax = fig.gca()
ax.pcolormesh(X, Y, Z, cmap=matplotlib.cm.coolwarm)

fig.savefig('figures/Darg.png')
